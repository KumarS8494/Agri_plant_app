...
import torch
from Model_logic_aphid import load_model, preprocess_image, class_names, remedies, original_labels, amp_autocast
...
def render_mustard_aphid():

    # ====== Stylish Title ======
    st.markdown("""
        <h1 style='text-align: center; font-size: 32px;'>
            🍃 <span style='font-family:Georgia;'><em>AphidScan</em></span>: Mustard Aphid Infestation Analyzer
        </h1>
    """, unsafe_allow_html=True)

    st.markdown("""
        <p style='text-align: center; font-size: 18px;'>
            An AI-powered tool for detecting <strong>aphid infestation stages</strong> or confirming a <strong>healthy mustard plant</strong>.
        </p>
    """, unsafe_allow_html=True)

    st.markdown("---")

    # ====== Upload Section Header and Expander ======
